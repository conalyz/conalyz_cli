...
<head>
    ...
    <title>Flutter Accessibility Analysis Report</title>
    ...
    <div class="container">
        <div class="header">
            <div class="header-content">
                <h1>🔍 Flutter Accessibility Report</h1>
                <div class="subtitle">
                    AST-based Analysis • Generated on ${DateTime.now().toString().split('.')[0]} • Platform: ${result.platform.toString().split('.').last}
                    <span class="badge ast">AST-powered</span>
                </div>
            </div>
        </div>
        ...
        <div class="footer">
            <p>Generated by Conalyz CLI (AST-based) • 
            <a href="https://github.com/conalyz/conalyz_cli" target="_blank" rel="noopener noreferrer">GitHub</a></p>
        </div>
    </div>
</body>
</html>
